...
def is_member(user_id):
    try:
        member_status = bot.get_chat_member('-1001966099561', user_id)
...
def send_welcome(message):
    ...
    inline_keyboard.row(
        telebot.types.InlineKeyboardButton("〇 𝐉𝐨𝐢𝐧𝐞 𝐂𝐡𝐚𝐧𝐧𝐞𝐥 〇", url=f"https://t.me/movies_island8"),
        telebot.types.InlineKeyboardButton("🫧 𝐎𝐡 𝐁𝐡𝐚𝐢 🫧", url="tg://user?id=5838674798")
    )
